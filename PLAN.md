...
| 6 | Image Processing & Vision | T-IP, T-PAMI / CVPR, ICCV |
| 7 | Communications & Information Theory | T-COM, TWC, JSAC, T-IT / ISIT |
| 8 | Networking | IEEE/ACM ToN / INFOCOM, SIGCOMM |
| 9 | Control Systems | TAC, Automatica / CDC |
| 10 | Robotics | T-RO / ICRA, RSS, RA-L |
...
| 14 | Photonics & Optics | JLT, Optica / CLEO, OFC |
| 15 | Electromagnetics, Antennas & RF | T-AP, T-MTT / IMS |
| 16 | MEMS & Microsystems | J-MEMS / IEEE MEMS |
| 17 | Hardware Security | T-IFS, T-Info Forensics / CHES, HOST |
| 18 | Machine Learning | — / NeurIPS, ICML, ICLR |
| 19 | Biomedical Engineering | T-BME / — |
| 20 | Quantum Engineering | npj Quantum Information, PRX Quantum, Quantum Science and Technology / — |
| 21 | Nature family — ECE (default-off) | Nature Electronics, Nature Photonics, Light: Sci. & Appl. |
